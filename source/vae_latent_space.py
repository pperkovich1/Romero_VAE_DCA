...
def save_latent_space_from_config(config, input_filename=None,
    ...
    # This is not a pandas Dataframe but Pandas is convient for pickling
...
if __name__=='__main__':
    ...
    save_latent_space_from_config(config, input_filename=args.input_filename,
